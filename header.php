...
<header class="relative w-full bg-[#1A1A1A]">
  <div class="flex py-5 px-4 md:px-[162px] justify-between items-center">
    ...
    <div class="flex items-center gap-4">
      ...
      <div class="hidden md:flex py-4 px-6 items-center gap-2 rounded-[10px] border border-[#262626] bg-[#141414]">
...
<!-- Mobile Menu Drawer -->
    <div
      id="mobile-menu"
      class="md:hidden bg-[#141414]"
      aria-hidden="true"
    >
      <div class="px-6 py-4 flex flex-col gap-4" style="overflow: hidden;">
